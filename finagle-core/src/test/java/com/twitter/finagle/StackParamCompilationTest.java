...
public class StackParamCompilationTest {
  void testParams() {
    ...
    Transporter.SocksProxy transporterSocksProxy =
      new Transporter.SocksProxy(SocksProxyFlags.socksProxy(), SocksProxyFlags.socksUsernameAndPassword());
    ...
    Transport.TLSClientEngine transportTLSClientEngine =
      new Transport.TLSClientEngine(Option.<scala.Function1<SocketAddress,com.twitter.finagle.ssl.Engine>>empty());
    Transport.TLSServerEngine transportTLSServerEngine =
      new Transport.TLSServerEngine(Option.<scala.Function0<com.twitter.finagle.ssl.Engine>>empty());
  }
}
