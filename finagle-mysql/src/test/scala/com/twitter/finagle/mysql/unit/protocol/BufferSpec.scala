...
class BufferSpec extends SpecificationWithJUnit {
  "Buffer" should {
    "read" in {
      ...
      "Signed Int" in {
        val n = 0xfffff6ff
        val br = new BufferReader(Array[Byte](0xff.toByte, 0xf6.toByte, 0xff.toByte, 0xff.toByte))
      ...
      "Read null terminated string" in {
        ...
        val br = new BufferReader(str.getBytes)
