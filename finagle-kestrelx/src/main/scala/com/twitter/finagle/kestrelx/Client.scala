...
/**
 * Indicates that a [[com.twitter.finagle.kestrelx.ReadHandle]] has been closed.
 */
object ReadClosedException extends Exception

/**
 * Indicates that a [[com.twitter.finagle.kestrelx.ReadHandle]] has exceeded its
 * retry budget.
 */
...
/**
 * Factory of command executors for [[com.twitter.finagle.kestrelx.ClientBase]]
 * @tparam U the type used to execute commands in
 *           [[com.twitter.finagle.kestrelx.ClientBase.read]]
 */
abstract protected[kestrelx] class CommandExecutorFactory[U]
  extends Closable {
  def apply(): Future[U]
}
 ...
 *                items
 */
abstract protected[kestrelx] class ClientBase[CommandExecutor <: Closable, Reply, ItemId](
 ...
 * [[com.twitter.finagle.kestrelx.ClientBase]]
 ...
 */
protected[kestrelx] class ConnectedClient(underlying: ServiceFactory[Command, Response])
 ...
 */
protected[kestrelx] class FinagledClosableClient(service: Service[ThriftClientRequest, Array[Byte]])
 ...
 */
protected[kestrelx] class FinagledClientFactory(
 ...
 */
protected[kestrelx] class ThriftConnectedClient(underlying: FinagledClientFactory, txnAbortTimeout: Duration)
