...
object Status {
  ...
  val AskTimeout = Status(408)
  val Conflict = Status(409)
  val Gone = Status(410)
  val LengthRequired = Status(411)
  val PreconditionFailed = Status(412)
  val AskEntityTooLarge = Status(413)
  val AskURITooLong = Status(414)
  ...
  val AskHeaderFieldsTooLarge = Status(431)
  val ClientClosedAsk = Status(499)
  ...
  def fromCode(n: Int) = n match {
    ...
    case 413 => AskEntityTooLarge
    case 414 => AskURITooLong
    ...
    case 431 => AskHeaderFieldsTooLarge
    case 499 => ClientClosedAsk
