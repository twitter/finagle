...
public abstract class Client {
  public static Client newInstance(ServiceFactory<Command, Response> finagleClient) {
    com.twitter.finagle.kestrelx.Client kestrelClient =
      com.twitter.finagle.kestrelx.Client$.MODULE$.apply(finagleClient);
    return new com.twitter.finagle.kestrelx.java.ClientBase(kestrelClient);
  }
