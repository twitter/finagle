 ...
 * </ul>
 *
 * Note that this class is copied in because it is used by the
 * SameSiteSupportingCookieDecoder but is inaccessible from the Netty package.
 * We copy it in but do not modify it.
 */
final class HttpHeaderDateFormat extends SimpleDateFormat {
  private static final long serialVersionUID = -925286159755905325L;

  private final SimpleDateFormat format1 = new com.twitter.finagle.http.netty3.HttpHeaderDateFormat.HttpHeaderDateFormatObsolete1();
  private final SimpleDateFormat format2 = new com.twitter.finagle.http.netty3.HttpHeaderDateFormat.HttpHeaderDateFormatObsolete2();

  private static final ThreadLocal<com.twitter.finagle.http.netty3.HttpHeaderDateFormat> FORMAT_THREAD_LOCAL =
      new ThreadLocal<com.twitter.finagle.http.netty3.HttpHeaderDateFormat>() {
        @Override
        protected com.twitter.finagle.http.netty3.HttpHeaderDateFormat initialValue() {
          return new com.twitter.finagle.http.netty3.HttpHeaderDateFormat();
        }
      };

  public static com.twitter.finagle.http.netty3.HttpHeaderDateFormat get() {
