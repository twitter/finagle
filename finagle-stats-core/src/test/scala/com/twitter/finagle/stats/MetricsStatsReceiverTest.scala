  ...
  class SchemaCtx extends TestCtx {
    ...
    def addCounter(
      ...
      statsReceiver.counter(
        CounterSchema(
          new MetricBuilder(name = name, statsReceiver = statsReceiver, verbosity = verbosity)))
    def addGauge(
      statsReceiver: StatsReceiver,
      name: Seq[String],
      verbosity: Verbosity = Verbosity.Default
      ...
      statsReceiver.addGauge(
        GaugeSchema(
          new MetricBuilder(name = name, statsReceiver = statsReceiver, verbosity = verbosity)))(f)
    def addHisto(
      statsReceiver: StatsReceiver,
      name: Seq[String],
      verbosity: Verbosity = Verbosity.Default
