...
case class SentinelFailover(arg: String)
  extends Sentinel("FAILOVER", Seq(arg))

case class SentinelCkQuorum(arg: String)
  extends Sentinel("CKQUORUM", Seq(arg))
...
case class SentinelRemove(arg: String)
  extends Sentinel("REMOVE", Seq(arg))
