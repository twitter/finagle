 ...
 * }}}
 *
 * @define reqRepServicePerEndpoint
 *
...
trait ThriftRichClient { self: Client[ThriftClientRequest, Array[Byte]] =>
   ...
   * @param label Assign a label for scoped stats.
   */
  def servicePerEndpoint[ServicePerEndpoint <: ThriftServiceIface.Filterable[ServicePerEndpoint]](
    dest: String,
    label: String
  )(
  ...
  def reqRepServicePerEndpoint[ReqRepServicePerEndpoint <: Filterable[ReqRepServicePerEndpoint]](
    ...
    reqRepServicePerEndpoint(Resolver.eval(dest), label)
  }
  ...
  def reqRepServicePerEndpoint[ReqRepServicePerEndpoint <: Filterable[ReqRepServicePerEndpoint]](
    ...
    implicit builder: ReqRepServicePerEndpointBuilder[ReqRepServicePerEndpoint]): ReqRepServicePerEndpoint = {
    val thriftService = newService(dest, label)
    reqRepServicePerEndpoint(thriftService, label)
  }

  /**
   * $reqRepServicePerEndpoint
   *
   * @param service The Finagle Thrift [[Service]] to be used.
   * @param label Assign a label for scoped stats.
   * @param builder The builder type is generated by Scrooge for a thrift service.
   */
  def reqRepServicePerEndpoint[ReqRepServicePerEndpoint <: Filterable[ReqRepServicePerEndpoint]](
   ...
   */
  @deprecated("Use com.twitter.finagle.ThriftRichClient#methodPerEndpoint[ServicePerEndpoint, MethodPerEndpoint]", "2017-11-13")
  ...
  class MultiplexedThriftClient(dest: Name, label: String) {
    ...
    def reqRepServicePerEndpoint[ReqRepServicePerEndpoint <: ThriftServiceIface.Filterable[ReqRepServicePerEndpoint]](
      serviceName: String
    )(
      implicit builder: ReqRepServicePerEndpointBuilder[ReqRepServicePerEndpoint]
    ): ReqRepServicePerEndpoint = {
