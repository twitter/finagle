 ...
 *
 * @param _maxRequestSize The maximum size of the request to receive (default is 5 megabytes).
 * Should be less than 2 gigabytes (up to `Int.MaxValue` bytes). Use streaming/chunked requests
 * to handle larger messages.
 *
 * @param _maxResponseSize The maximum size of the response to send (default is 5 megabytes).
 * Should be less than 2 gigabytes (up to `Int.MaxValue` bytes). Use streaming/chunked requests
 * to handle larger messages.
 *
