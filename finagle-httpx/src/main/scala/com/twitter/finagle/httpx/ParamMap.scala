...
import com.twitter.finagle.httpx.util.StringUtil
...
object MapParamMap {
  ...
  private[httpx] def tuplesToMultiMap(
...
object ParamMap {
  ...
  private[httpx] val EmptyJMap = new java.util.HashMap[String, JList[String]]
}
