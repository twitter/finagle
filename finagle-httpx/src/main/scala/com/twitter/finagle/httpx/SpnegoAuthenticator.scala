...
object SpnegoAuthenticator {
  ...
  object Authenticated {
    case class Http(override val httpRequest: Request, context: GSSContext)
  ...
  extends SpnegoAuthenticator[Request, Response](
    ...
    protected[this] def getNegotiation(req: Request): Option[Array[Byte]] =
      Option(req.headers.get(Fields.Authorization)) flatMap {
    ...
    protected[this] def authenticated(req: Request, context: GSSContext): Authenticated.Http =
