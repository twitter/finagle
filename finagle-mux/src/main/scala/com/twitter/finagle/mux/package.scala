 ...
 * Treq.
 *
 * ''size:4 Rdiscarded:1 tag:3'' is a marker message indicating that the Tdiscarded
 * with the given tag has been processed. This can be used to clear any accumulated
 * message fragments on the receiving end. No further message fragments for the tag will
 * be sent after an Rdiscarded.
 *
